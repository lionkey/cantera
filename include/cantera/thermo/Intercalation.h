 ...
 */
#ifndef CT_INTERCALATION_H
#define CT_INTERCALATION_H
 ...
 * @ingroup thermoprops
 */
class Intercalation : public ConstDensityThermo
{
public:
    //! Constructor.
    Intercalation() {}
     ...
     */
    Intercalation(const Intercalation& right);

    //! Assignment Operator
    /*!
     * @param right Object to be copied
     */
    Intercalation& operator=(const Intercalation& right);
    ...
    //! Current intercalating species index
    size_t m_kk_int;
...
#endif /* INCLUDE_CANTERA_THERMO_INTERCALATION_H_ */
